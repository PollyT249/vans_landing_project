...
export const BentoCard = ({ src, title, description, seeMore }) => {
  ...
  return (
    <div className="relative size-full">
      ...
      />
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-green-100">
        <div>
          <h1 className="bento-title special-font">{title}</h1>
          {description && (
            <p className="mt-3 max-w-64 text-xs md:text-base text-green-75">
              {description}
            </p>
          )}
        </div>
        ...
        {seeMore && (
          <div
            ...
            onMouseLeave={handleMouseLeave}
            className="border-hsla relative flex w-fit cursor-pointer items-center gap-1 overflow-hidden rounded-full bg-brown-400 px-5 py-2 text-xs uppercase text-white/20"
          >
    ...
    <div className="container mx-auto px-3 md:px-10">
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-tilt_2">
          <div className="flex size-full flex-col justify-between bg-brown-300 p-5">
            <h1 className="bento-title special-font max-w-64 text-violet-300">
              More coming soon.
            </h1>
